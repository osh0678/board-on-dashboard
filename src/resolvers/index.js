...
/** 상한 근거 — 2026-08 실측 (보드 1,010건 기준)
 *  · 1,000건 단일 호출: 평균 1,070ms / 최대 1,116ms → Forge 25초 한도의 4.5%
 *  · 페이로드 약 1.1MB. 더 키우면 시간보다 렌더링·전송이 먼저 병목
 *  · 순차 페이지네이션은 호출당 약 370ms → 1만건이면 37초로 한도 초과
 *  → 단일 호출로 끝나는 1,000을 상한으로 고정하고 초과분은 안내 처리
 */
